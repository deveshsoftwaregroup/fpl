  ...
  <div class="row">
          ...
          <div class="col-lg-10 col-lg-offset-1 col-md-10 col-md-offset-1 col-sm-10 col-sm-offset-1">
            <div class="row">
                   ...
                   <ul class="bxslider_1">
                      <li class="home_scout_section">
                          ...
                          <div class="col-lg-7 col-sm-6 col-tn-6 col-xs-12">
                            <img src="${context}/redBlackTheme/images/scout-img.png" >
                          </div>
                ...
                <div class="col-lg-4 col-sm-4 col-tn-12 col-xs-12 all_play">
                    <a href="" data-toggle="modal" data-target="#myModal1"><img src="${context}/redBlackTheme/images/play-fantasy-league.png" class="img-responsive center-block"></a>
                    <br>
       ...
       <div class="row">
          <div class="col-lg-10 col-lg-offset-1 col-md-10 col-md-offset-1 col-sm-10 col-sm-offset-1 our_partners ">
            <div class="row">
              <div class="col-lg-2 col-md-2"><h3>Our Partners</h3></div>
