						...
						<li class="home_scout_section">
							<div class="row ">
						    	...
						    	<div class="col-lg-5 col-sm-6 col-tn-6 col-xs-12">
						        	...
						        	<p><a target="_blank" href="http://the12thman.in/defender-contender-rio-ferdinand-marks-return/"><b> READ MORE </b></a>- the12thman.in</p>
						    	</div>
						    </div>
						</li>
							...
							<div class="row">
								...
								<div class="col-lg-5 col-sm-6 col-tn-6 col-xs-12">
								  <h4>Hazard opens up on Ligue 1 return </h4>
								    ...
								    <p><a target="_blank" href="http://the12thman.in/hazard-opens-ligue-1-return/"><b> READ MORE </b></a>- the12thman.in</p>
								</div>
							</div>
						</li>
						<li class="home_scout_section">
							<div class="row ">
						    	<div class="col-lg-7 col-sm-6 col-tn-6 col-xs-12">
	                            	...
	                            	<h4>MAanchester united Jos star opens contract talk with Manchester United </h4>
	                                  ...
	                                  <p><a target="_blank" href="http://the12thman.in/joses-star-opens-contract-talk-manchester-united/"><b> READ MORE </b></a>- the12thman.in</p>   
	                          	</div>
						    </div>
						</li>
                    ...
                    <ul class="scout_list ">
                        ...
                        <li>
                            <h4>Aguero form a major boost for Manchester City </h4>
                              ...
                              <p><a target="_blank" href="http://the12thman.in/agueros-form-major-boost-manchester-city/"><b>READ MORE</b></a>- the12thman.in</p>
                        </li>
