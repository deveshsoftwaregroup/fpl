                  ...
                  <div class="col-lg-8 team_map_dream11">
                     <div class="row ">
                        ...
                        <ul class="itemsContainer ">
                           <li >
                              <a href="#"> <img src="${context}/redBlackTheme/images/Dream11/goalkeeper.png" class=" img-responsive gaolkeeper_hvr" ></a>
                              <h4>Player</h4>
                           </li>
                        </ul>
                             </div>
                     ...
                     <div class="row ">
                        ...
                        <ul >
                           <li>
                              <a href="#"> <img src="${context}/redBlackTheme/images/Dream11/player_1.png" class="center-block img-responsive" > </a>
                              <h4>Player</h4>
                           </li>
                           <li>
                              <a href="#"> <img src="${context}/redBlackTheme/images/Dream11/player_1.png" class="center-block img-responsive" ></a>
                     ...
                     <div class="row ">
                      ...
                      <div class="row">
                        <div class="col-lg-4 pull-right claim_your_prize">
                            <h4>Your points : xxxx</h4>
                            <a href="#"><button type="button" class="btn claim_btn">Claim Your Prize</button></a>
                          </div>    
                      </div>
