            ...
            <div class="league-pager">
               ...
               <h3>My Fantasy Team</h3>
	                    ...
	                    <div class="ism-element-row ism-element-row--pitch">
	                      ...
	                      <div class="row">
	                        <div class="col-lg-4 pull-right claim_your_prize">
	                           ...
	                           <a href="#"><button type="button" class="btn claim_btn" onclick="uploadCouponsView('${sessionScope.userId}','${sessionScope.gameDetails.gameId}');">Claim Your Prize</button></a>
	                          </div>    
	                      </div>
                  ...
                  <div class="col-lg-4 col-lg-offset-0 col-md-6 col-md-offset-3 col-sm-8 col-sm-offset-2   Dream_11_players ">
                        <div class="row"> 
                            <div class="Dream_11_list"> <h4>FANTASY LEAGUE</h4></div>
  <table width="100%">
  <tbody>
    <tr class="head_table">
      <td>S No.</td>
