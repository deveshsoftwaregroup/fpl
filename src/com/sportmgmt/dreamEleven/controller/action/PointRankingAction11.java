...
public class PointRankingAction11 {
	Logger logger = Logger.getLogger(PointRankingAction11.class);
	@Autowired
	...
	@RequestMapping(value = "MyPoint11/{gameId}/{userId}", method = RequestMethod.GET)
