...
public class GameAction11 {
	private Logger logger = Logger.getLogger(GameAction11.class);
	@Autowired
	...
	@RequestMapping(value = "AddPlayer11", method = RequestMethod.GET)
	public @ResponseBody Map addPlayer(@RequestParam("userId") String userId, @RequestParam("gameClubPlayerId") String gameClubPlayerId,HttpServletRequest request)
	{
		...
		else
		{
			...
			if(user != null)
			{
				...
				{
					isSuccess = GameManager.addPlayerOfGametToUserAccountDreamEleven(userId, gameClubPlayerId);
					Double price = null;
	...
	@RequestMapping(value = "RemovePlayer11", method = RequestMethod.GET)
	public @ResponseBody Map removePlayer(@RequestParam("userId") String userId, @RequestParam("gameClubPlayerId") String gameClubPlayerId,HttpServletRequest request)
	{
		...
		{
			isSuccess = GameManager.removePlayeOfGameFromUserAccountDreamEleven(userId, gameClubPlayerId);
	...
	@RequestMapping(value = "ActivatePlayer11", method = RequestMethod.GET)
	...
	@RequestMapping(value = "DeActivatePlayer11", method = RequestMethod.GET)
	...
	@RequestMapping(value = "MakeCaptain11", method = RequestMethod.GET)
	...
	@RequestMapping(value = "MakeViceCaptain11", method = RequestMethod.GET)
	...
	@RequestMapping(value = "SortPlayer11/{orderBy}", method = RequestMethod.GET)
